...
DO_CLEANUP="yes"
COMPILE_DEBUG="no"
COMPILE_LEVELDB="yes" #Here
HAVE_VALGRIND="--without-valgrind"
HAVE_OPCACHE="no" #Here
FSANITIZE_OPTIONS=""
FLAGS_LTO=""
...
echo -n " modifying..."
#We need modify the source to fit Android native compiling
...
#endif
' > ext/pthreads/src/sun_len.h
sed -i '1i #include<src/sun_len.h>' ext/pthreads/src/socket.c
